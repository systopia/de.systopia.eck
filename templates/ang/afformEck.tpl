<af-form ctrl="afform">
  <af-entity type="{$entityType.entity_name}" name="{$entityType.entity_name}" label="{$subType.label}" actions="{ldelim}create: true, update: true{rdelim}" security="RBAC" url-autofill="1" data="{ldelim}subtype: {$subType.value|json|escape}{rdelim}" ></af-entity>
