 ...
 */
class CRM_Eck_Upgrader_Base {

  /**
   * @var CRM_Eck_Upgrader_Base
   */
  ...
  public static function instance() {
    if (!self::$instance) {
      self::$instance = new CRM_Eck_Upgrader(
        'de.systopia.eck',
        E::path()
      );
    }
   ...
   *
   * ```
   * CRM_Eck_Upgrader_Base::_queueAdapter($ctx, 'methodName', 'arg1', 'arg2');
   * ```
   */
  ...
  /**
   * CRM_Eck_Upgrader_Base constructor.
   *
   * @param $extensionName
   * @param $extensionDir
   */
